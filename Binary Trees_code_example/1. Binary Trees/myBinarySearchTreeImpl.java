...
public class myBinarySearchTreeImpl<T1 extends Comparable<? super T1>, T2> implements myBinarySearchTree<T1, T2> {
	...
	//-------------------------------------------------------------------
	// Create a non-empty myBinarySearchTree using a new element and two myBinarySearchTree: create_empty
	//-------------------------------------------------------------------
	...
	//-------------------------------------------------------------------
	// Basic Operation --> Get right tree of myBinarySearchTree: my_right_tree
	//-------------------------------------------------------------------
	...
	public myList<T2> my_inorder(){
		...
		myList<T2> list = new myListLinkedList<T2>();
