...
public class MainGraphs {
    ...
    public static void main(String[] args) {
        ...
        int V = 5; // number of vertices --> 0, 1, 2, 3, 4 --> which is why line 84 fails (5 doesn't exist)
        ...
        m.addEdge(1, 3, 1);                              // Source, destination, weight
        m.addEdge(1, 4, 2);
        m.addEdge(2, 3, 7);
        m.addEdge(1, 3, 4);
        m.addEdge(4, 0, 8);
        ...
        System.out.println("Graph Vertices: " + m.numVerts());      // Vertices = circles/nodes
        System.out.println("Graph Edges: " + m.numEdges());         // Edges = line between nodes
        System.out.println(" ");
