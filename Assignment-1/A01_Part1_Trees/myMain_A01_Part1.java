...
public class myMain_A01_Part1 {
    ...
    public static void main(String[] args) {
        ...
        initialise_tree(myTree1, true);     // Does not contain key 9
        initialise_tree(myTree2, false);    // Contains key 9
        ...
        System.out.println("Is myTree1 balanced? " + myTree1.my_is_balanced());        // Balanced
        System.out.println("Is myTree2 balanced? " + myTree2.my_is_balanced());        // Not balanced (because key 9 is added)
